...
class DirectoryModel {
  DirectoryModel({required this.path, required this.name, this.fileNumber = 0, this.directorySourceType = DirectorySourceType.localDirectory, this.assetPathEntity});
